...
<div class="nav">
        ...
        <div class="sform container">
            ...
            <form method="post">
                ...
                <div class style="text-align:right;"> <br> <a href="css.php" onclick="return confirm('Are you sure?')" id="back"> <-- Go Back </a> </div>
            </form>
        </div>
    </div>
    </div>
...
if (isset($_POST{'submit'}))
 ...
 $query="insert into css_questions(que_no,question,one,two,three,four,answer)values('$que_no','$question','$one','$two','$three','$four','$answer')";
