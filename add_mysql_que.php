...
<div class="nav">
            <label for="toggle">&#9776;</label>
                ...
                <div class="menu">
                        <a href="add_mysql_que.php">ADD QUESTION</a>
                        <a href="delete_mysql_que.php">DELETE QUESTION</a>
                        <a href="update_mysql_que.php">UPDATE QUESTION</a>
                        <a href="logout.php"><strong> LOGOUT</strong></a>
                    </div>
</div>

<div class="sform container">
            <h1> Add MYSQL Questions </h1>
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <label for="">Answer</label>
                        ...
                        <button type="submit" name="submit" class="btn-primary btn-block">Add Question</button>
                    </div>
                </div>

                <!-- <button type="submit" name="submit" class="btn btn-primary btn-block">Register</button> -->
                <div class style="text-align:right;"> <br> <a href="mysql.php" onclick="return confirm('Are you sure?')" id="back"> <-- Go Back </a> </div>
            </form>
        </div>
    </div>
    </div>
...
if (isset($_POST{'submit'}))
 ...
 $query="insert into mysql_questions(que_no,question,one,two,three,four,answer)values('$que_no','$question','$one','$two','$three','$four','$answer')";
