            ...
            <form method="post">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <button type="submit" name="submit" class="btn-primary btn-block">Register</button>
                    </div>
                </div>
...
if (isset($_POST{'submit'}))
 ...
 $query="insert into sregister(name,mobile,email,rollno,course,gender,password)values('$name','$mobile','$email','$rollno','$course','$gender','$password')";
