...
if (isset($_POST{'submit'}))
 {
    ...
    $query="update mysql_questions set question = '$question', one='$one', two='$two', three='$three', four='$four', answer='$answer' where que_no='$que_no'";
