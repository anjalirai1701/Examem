...
<div class="nav">
            <label for="toggle">&#9776;</label>
                ...
                <div class="menu">
                        <a href="add_php_que.php">ADD QUESTION</a>
                        <a href="delete_php_que.php">DELETE QUESTION</a>
                        <a href="update_php_que.php">UPDATE QUESTION</a>
                        <a href="logout.php"><strong> LOGOUT</strong></a>
                    </div>
</div>

<div class="sform container">
            <h1> Add PHP Questions </h1>
            <form method="post">
                ...
                <div class style="text-align:right;"> <br> <a href="php.php" onclick="return confirm('Are you sure?')" id="back"> <-- Go Back </a> </div>
            </form>
        </div>
    </div>
    </div>
...
if (isset($_POST{'submit'}))
 ...
 $query="insert into php_questions(que_no,question,one,two,three,four,answer)values('$que_no','$question','$one','$two','$three','$four','$answer')";
